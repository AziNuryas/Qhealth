...
<style>
    ...
    .register-card {
        ...
        margin-bottom: 2rem;
        position: relative;
        max-width: 450px; /* Lebih kecil dari sebelumnya */
        margin-left: auto;
        margin-right: auto;
    }
    ...
    .form-group label {
        font-weight: 500;
        margin-bottom: 0.3rem; /* Jarak label ke input lebih kecil */
        display: block;
        transition: all 0.3s ease;
    ...
    .form-control {
        ...
        padding: 0.6rem 0.8rem; /* Padding input lebih kecil */
        border: 1px solid rgba(255, 255, 255, 0.3);
    ...
    .btn-register {
        ...
        border: none;
        border-radius: 8px; /* Border radius lebih kecil */
        padding: 0.6rem 1rem; /* Padding button lebih kecil */
        font-weight: 500;
        transition: all 0.3s ease;
        ...
        opacity: 0;
        transform: translateY(10px);
        font-size: 0.95rem; /* Font button lebih kecil */
    }
    ...
    .register-card::before {
        ...
        top: -10px;
        right: -10px;
        width: 40px; /* Ukuran dekorasi lebih kecil */
        height: 40px;
    ...
    .register-card::after {
        ...
        bottom: -15px;
        left: -15px;
        width: 60px; /* Ukuran dekorasi lebih kecil */
        height: 60px;
    ...
    .login-link {
        text-align: center;
        margin-top: 0.8rem; /* Margin lebih kecil */
        opacity: 0;
        transform: translateY(10px);
        animation: fadeIn 0.8s forwards;
    ...
    .register-illustration {
        height: 90px; /* Tinggi ilustrasi lebih kecil */
        width: 100%;
        display: flex;
    ...
    .register-icon {
        font-size: 60px; /* Ukuran icon lebih kecil */
        color: #22c55e;
        opacity: 0.7;
    }
...
<div class="container py-4">
    <div class="row justify-content-center">
        <div class="col-md-5"> <!-- Ukuran kolom lebih kecil -->
            <div class="register-card" data-aos="fade-up">
                <div class="register-illustration">
                    <i class="bi bi-person-plus-fill register-icon"></i>
                </div>

                <h3 class="register-title animate-fade-in">Daftar Akun</h3>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <button type="submit" class="btn btn-register animate-fade-in delay-4">
